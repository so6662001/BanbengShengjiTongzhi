  ...
  <div>
    ...
    <el-dialog v-model="visible" title="新建发布计划" width="520px">
      <el-form label-width="100px">
        <el-form-item label="版本ID"><el-input v-model.number="form.versionId" /></el-form-item>
        <el-form-item label="人群ID"><el-input v-model.number="form.audienceId" /></el-form-item>
